# Tipconnecta — UX Blueprint (Investown‑style) v1.0
...
**A2: Rezervační wizard (modal / page)**
Krok 1 — Investor
- vybrat existující / vytvořit nového (minimálně: jméno, e‑mail, tel.)
Krok 2 — Parametry rezervace
- částka, poznámka pro developera, potvrzení podmínek
Krok 3 — Shrnutí
- co investor podepíše (Souhlas + NDA + rezervační smlouva), SLA 48h
