# Tipari.cz – Kanonický souhrn dat (verze 1.8 – data)

**Stav dokumentu:** **DATA UZAMČENA (verze 1.8)**. Tento soubor je kanonický zdroj pravdy pro implementaci dat a business logiky.

**Verze:** 1.8 (data – uzamčeno)

**Datum uzamčení:** 2026-01-22

**Navazuje na:** interní pracovní revizi 6.0 (živý dokument)

## Dokumenty v balíčku (verze 1.8)

- **Souhrn dat (kanonický, uzamčeno)**: `Tipari_Souhrn_Dat_DATA_v1.8.md` (tento soubor)
...
#### 0.4 Změnový log (revize 6.0 → 1.8 – data)

- Dokument je **uzamčený jako verze 1.8 – data** (tj. kanonická data a pravidla jsou připravená pro implementaci).
...
- Doplněn **katalog notifikací** (spouštěče, příjemci, kanály, datové proměnné) – kapitola 21.5.
- Doplněn **profil a nastavení účtu** pro obchodníka/developera/admin (funkční obsah) – kapitola 23.
...
- Podpisové dokumenty investora: **Souhlas se sdílením údajů** + **NDA (investor ↔ platforma)** (elektronický podpis)
- Rezervační smlouva (elektronický podpis)
...
- Registrace obchodníka a registrace developera (kapitola 12.2 a 12.3)
- Zadání projektu a tiketu (kapitola 12.5 a 12.6 + datový slovník v kapitole 8)
- Evidence investora (interní databáze obchodníka)
- Vytvoření rezervace a workflow podpisů (elektronicky přes eSign)
...
4) obchodník odešle investorovi odkaz na elektronický podpis (eSign). Od tohoto okamžiku běží SLA investora pro **Souhlas + NDA** (**výchozí 48 hodin**, nastavitelné administrátorem na úrovni tiketu). Po potvrzení Souhlasu + NDA začíná běžet SLA investora pro **podpis rezervační smlouvy** (**výchozí 48 hodin**, nastavitelné administrátorem / per rezervaci).
...
2) **Před odesláním** rezervace obchodník vidí pouze **anonymizovaný/částečně zamaskovaný** obsah:
   ...
   - obrázky k projektu (v „maskované“ podobě; titulní obrázek i galerie se zobrazují jako placeholder),
...
3) Obchodník rezervaci **potvrdí a odešle investorovi**.
   ...
   - Od tohoto okamžiku běží SLA investora pro **Souhlas + NDA** (výchozí **48 hodin**, nastavitelné; prodlužuje administrátor).
...
5) Jakmile investor podepíše **Souhlas + NDA**:
   ...
   - současně začne běžet SLA investora pro podpis **rezervační smlouvy** (výchozí **48 hodin**, nastavitelné; prodlužuje administrátor).
...
- po **odeslání** investorovi běží SLA investora pro **Souhlas + NDA** (výchozí 48h); po potvrzení Souhlasu+NDA začíná SLA investora pro podpis **rezervační smlouvy** (výchozí 48h)
...
- Obchodník vidí u projektu/tiketu pouze **maskované** informace: název projektu, název developera, obrázky projektu (hlavní náhled i galerie – placeholder) a většinu dokumentů.
...
| Hlavní obrázek projektu (náhled) | file | volitelně | developer | Developer, admin; obchodník až po podpisu Souhlasu + NDA investorem. | Používá se jako thumbnail na kartě tiketu. Před odmaskováním se zobrazuje placeholder. |
| Obrázky projektu (galerie) | list(file) | volitelně | developer | Developer, admin; obchodník až po podpisu Souhlasu + NDA investorem. | Galerie je skrytá do odmaskování; před odmaskováním se zobrazuje placeholder. |
...
Poznámka k vazbě na projekt (pro zobrazení):
...
| Čas na potvrzení Souhlasu + NDA investorem | duration | ano | administrátor | administrátor | Výchozí 48h |
| Čas na podpis rezervační smlouvy investorem | duration | ano | administrátor | administrátor | Výchozí 48h (počítáno od potvrzení Souhlasu + NDA investorem / zpřístupnění rezervační smlouvy) |
...
| Datum a čas odeslání investorovi | datetime | ano | systém | admin, obchodník | Od tohoto okamžiku běží SLA pro potvrzení Souhlasu + NDA investorem. |
| Termín pro potvrzení Souhlasu + NDA investorem | datetime | ano | systém | admin, obchodník | Deadline pro dokončení Souhlasu + NDA. Výchozí: datum a čas odeslání + SLA pro Souhlas + NDA. |
| Termín pro podpis rezervační smlouvy investorem | datetime | volitelné | systém | admin, obchodník | Vzniká po potvrzení Souhlasu + NDA. Výchozí: datum/čas podpisu Souhlasu + NDA + SLA pro rezervační smlouvu. |
...
| Lhůta potvrzení Souhlasu + NDA investorem | Per tiket + per rezervaci | hodiny | 48 | 1–720 | ovlivní deadline potvrzení Souhlasu+NDA (běžící i budoucí) | administrátor |
| Lhůta podpisu rezervační smlouvy investorem | Per tiket + per rezervaci | hodiny | 48 | 1–720 | ovlivní deadline podpisu rezervační smlouvy investorem (běžící i budoucí) | administrátor |
...
| Odesláno investorovi (čeká na Souhlas + NDA) | Rezervace byla odeslána investorovi k podpisu, čeká se na potvrzení Souhlasu se sdílením údajů a NDA | obchodník odešle eSign odkaz | Běží SLA investora pro Souhlas+NDA (výchozí 48 hodin). Developer stále nevidí rezervaci. |
| Souhlas + NDA potvrzeny (čeká na podpis rezervační smlouvy investorem) | Investor podepsal Souhlas + NDA a může pokračovat k rezervační smlouvě | podpis investora Souhlas+NDA (eSign) | Vzniká auditní stopa introdukce. Obchodníkovi se odmaskují detaily projektu/developera. Developer uvidí probíhající rezervaci včetně jména investora a obchodníka (zatím bez akce). **Běží SLA investora pro podpis rezervační smlouvy (výchozí 48 hodin).** |
...
> Poznámka: Níže jsou „události“ (spouštěče). UX tým doplní finální texty šablon, ale tabulka už říká, **jaká data musí šablona umět vložit**.
...
| Rezervace / eSign | Rezervace odeslána investorovi | Obchodník potvrdí a odešle eSign balíček | Obchodník | In-app | ID rezervace, ID tiketu, deadline Souhlas+NDA (48h) | Maskované údaje projektu/developera stále platí až do podpisu Souhlas+NDA |
...
| Rezervace / eSign | Investor odmítl / nedokončil Souhlas+NDA | eSign webhook: odmítnuto / expirace | Obchodník + Admin | In-app + E-mail (volitelně) | ID rezervace, důvod (odmítnuto/expired), čas | — |
| Rezervace / eSign | Vypršelo SLA pro Souhlas+NDA | Uplynutí 48h od odeslání | Obchodník + Admin | In-app | ID rezervace, deadline, stav | — |
...
> Poznámka pro TipHub: Pokud váš prohlížeč Markdown podporuje **Mermaid**, níže uvedené bloky se vykreslí jako diagramy. Pokud Mermaid podporu nemá, diagramy se zobrazí jako text – v takovém případě lze dodat i export do obrázků (SVG/PNG).
...
sequenceDiagram
  ...
  participant P as Platforma Tipari
...
stateDiagram-v2
  ...
  OdeslanoInvestorovi --> Expirace: neproběhne do 48h

  SouhlasNDA_Podepsano --> RezSml_PodepsanaInvestor: investor podepíše rezervační smlouvu
  SouhlasNDA_Podepsano --> Expirace: nepodepíše do 48h
...
stateDiagram-v2
  ...
  Publikovany --> Expirace: uplynutí publikačního okna (90 dnů)
