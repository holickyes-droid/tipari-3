...
**Pozn.:** V UI se sekce jmenuje **Tikety**. Interně jde o „Marketplace“ (standardní nabídka tiketů).
...
- **DETAIL:** `/app/broker/tickets/:ticketId`
  ...
  - **MODAL • Galerie (lightbox):** `/app/broker/tickets/:ticketId?modal=gallery` *(doporučeno jako query param pro deep-link)*
