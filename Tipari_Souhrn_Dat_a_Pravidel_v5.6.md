...
Minimální náležitosti daňového dokladu, které má platforma pro každou fakturu držet a umět exportovat (dle zákona o dani z přidané hodnoty):
...
- Jednotková cena bez daně (pokud není osvobozeno).
- Základ daně.
- Sazba daně.
- Výše daně (zaokrouhlená na haléře dle pravidel v 10.6.3).
...
#### 16.4 Kanonické typy auditních událostí
...
| Oblast | Typ auditní události | Kdy vzniká | Povinné doplňující údaje |
|---|---|---|---|
...
| Ochrana osobních údajů | Přijetí žádosti o výmaz | Přijde žádost broker/investor/developer o výmaz osobních údajů | kdo žádá, jaké údaje, datum přijetí, termín pro výmaz |
| Ochrana osobních údajů | Provedení výmazu | Administrátor provede výmaz osobních údajů investora | rozsah výmazu, datum a čas, kdo provedl |
...
- Platforma v MVP **neprovádí AML/KYC ověření** obchodníka. Je to B2B vztah a ověření je mimo platformu.
