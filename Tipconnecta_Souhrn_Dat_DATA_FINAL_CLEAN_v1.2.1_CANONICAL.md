...
**Doc ID:** TIPCONNECTA-DATA-CLEAN-1.2.1  
**Verze:** DATA-CLEAN-1.2.1  
**Datum aktualizace:** 25. 1. 2026  

> Pozn.: Tipconnecta je rebranding původního projektu Tipari.cz. V této kanonické verzi používáme jednotně název **Tipconnecta**.

**Změny v této verzi (DATA-CLEAN-1.2.1):**
- Upřesnění: projektová média (cover + galerie) jsou využita na **kartě tiketu** i v **detailu tiketu**.
- Upřesnění: pravidla maskování/odemčení doplněna tak, aby byla konzistentní s UX Spec v2.8.1.
- Beze změny: ostatní datové entity a slovník (jen drobný úklid formulací, bez změny významu).
...
Poznámka: české platební příkazy typicky umožňují uvádět „variabilní symbol“, „specifický symbol“ a „konstantní symbol“ jako **volitelné** údaje platby. Pro Tipconnecta je ale důležité mít konzistentní pravidla pro párování, protože bankovní propojení není automatizované.
...
| Hlavní obrázek projektu (náhled) | file | volitelně | developer | Developer, admin; obchodník až po podpisu Souhlasu + NDA investorem. | Používá se jako thumbnail na kartě tiketu a jako hlavní (cover) obrázek v detailu tiketu. Před odmaskováním se zobrazuje placeholder. |
| Obrázky projektu (galerie) | list(file) | volitelně | developer | Developer, admin; obchodník až po podpisu Souhlasu + NDA investorem. | Galerie je skrytá do odmaskování; po odmaskování se zobrazuje v detailu tiketu (hero + lightbox). Před odmaskováním se zobrazuje placeholder. |
