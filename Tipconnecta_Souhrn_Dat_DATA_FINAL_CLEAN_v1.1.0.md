...
**Doc ID:** TIPCONNECTA-DATA-CLEAN-1.1.0  
**Verze:** DATA-CLEAN-1.1.0  
**Datum aktualizace:** 23. 1. 2026  

> Pozn.: Tipconnecta je rebranding původního projektu Tipari.cz. V této kanonické verzi používáme jednotně název **Tipconnecta**.

**Změny v této verzi (DATA-CLEAN-1.1.0):**
- Rebranding názvu platformy napříč dokumentem (Tipari.cz → Tipconnecta).
- Doplněna chybějící sekce 0.2 (kontext rebrandingu a cílového UI stylu).
- Opravy drobných formátovacích nedostatků (např. sekce 2.1).
