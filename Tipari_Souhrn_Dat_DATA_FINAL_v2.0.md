# Tipari.cz – Kanonický souhrn dat (verze 1.7 – data)

**Stav dokumentu:** **DATA UZAMČENA (verze 1.7)**. Tento soubor je kanonický zdroj pravdy pro implementaci dat a business logiky.

**Verze:** 1.7 (data – uzamčeno)
...
4) Investor podepisuje v eSign (mimo platformu) **vždy ve dvou krocích**:
   - **Krok 1:** Souhlas se sdílením osobních/firmních údajů (platforma + developer) **+** NDA (investor ↔ platforma).
...
1) **Souhlas se sdílením údajů** (investor ↔ platforma + developer),
