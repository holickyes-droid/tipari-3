# Tipari.cz – Kanonický souhrn dat (verze 1.6 – data)

**Stav dokumentu:** **DATA UZAMČENA (verze 1.6)**. Tento soubor je kanonický zdroj pravdy pro implementaci dat a business logiky.

**Verze:** 1.6 (data – uzamčeno)

**Datum uzamčení:** 2026-01-20

**Navazuje na:** interní pracovní revizi 6.0 (živý dokument)

## Dokumenty v balíčku (verze 1.6)

- **Souhrn dat (kanonický, uzamčeno)**: `Tipari_Souhrn_Dat_DATA_v1.6.md` (tento soubor)
...
#### 0.4 Změnový log (revize 6.0 → 1.2 – data)

- Dokument je **uzamčený jako verze 1.2 – data** (tj. kanonická data a pravidla jsou připravená pro implementaci).
